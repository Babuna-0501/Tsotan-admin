  ...
  <div class="fixed-plugin">
    ...
    <div class="shadow-lg card">
      <div class="pt-3 pb-0 bg-transparent card-header">
        ...
        >
          <h5 class="mt-3 mb-0">Админы тохиргоо</h5>
          <p>тохиргоотой танилцах</p>
        </div>
        <div
          class="mt-4"
          @click="toggle"
      ...
      <div class="pt-0 card-body pt-sm-3">
        <!-- Sidebar Backgrounds -->
        <div>
          <h6 class="mb-0">Мэню хэсгийн өнгийг солих</h6>
        </div>
        ...
        <!-- Sidenav Type -->
        <div class="mt-3">
          <h6 class="mb-0">Мэню хэсгийн өдөр шөнийн тохиргоо</h6>
        </div>
